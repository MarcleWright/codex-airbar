...
contextBridge.exposeInMainWorld("airbar", {
  ...
  getRecoveryStatus: () => ipcRenderer.invoke("recovery:getStatus"),
  setRecoveryEnabled: (enabled) => ipcRenderer.invoke("recovery:setEnabled", enabled),
  retryRecovery: (sessionId) => ipcRenderer.invoke("recovery:retry", sessionId),
